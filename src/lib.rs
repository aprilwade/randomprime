...
pub fn find_resource<'r, 'a, F>(gc_disc: &'r structs::GcDisc<'a>, pak_name: &str, mut f: F)
    -> Option<LCow<'r, structs::Resource<'a>>>
    where 'a: 'r,
          F: FnMut(&structs::Resource<'a>) -> bool
{
...
pub fn find_resource_mut<'r, 'a, F>(gc_disc: &'r mut structs::GcDisc<'a>, pak_name: &str, mut f: F)
