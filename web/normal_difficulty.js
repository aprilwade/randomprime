...
var NormalDifficultyReqs = (function() {
    ...
    var BOOST_BALL = DifficultyShared.BOOST_BALL;
    var SPIDER_BALL = DifficultyShared.SPIDER_BALL;

    var MORPH_BALL_BOMB = DifficultyShared.MORPH_BALL_BOMB;
    var POWER_BOMB_EXPANSION = DifficultyShared.POWER_BOMB_EXPANSION;
    var POWER_BOMB = DifficultyShared.POWER_BOMB;
    ...
    var SUPER_MISSILE = DifficultyShared.SUPER_MISSILE;
    ...
    var PHENDRANA_REQS = all(MISSILE, MORPH_BALL, MORPH_BALL_BOMB, ANY_SUIT);
    var BACKWARDS_PHENDRANA_REQS = all(MISSILE, MORPH_BALL, ANY_SUIT, SPIDER_BALL, SPACE_JUMP_BOOTS,
                                    WAVE_BEAM);
    var FRIGATE_REQS = all(MISSILE, MORPH_BALL, WAVE_BEAM, THERMAL_VISOR, GRAVITY_SUIT);
    var MINES_FROM_TALLON_REQS = all(MISSILE, MORPH_BALL, MORPH_BALL_BOMB, SPACE_JUMP_BOOTS,
                                    GRAVITY_SUIT, THERMAL_VISOR, WAVE_BEAM, ICE_BEAM);
    var MINES_FROM_MAGMOOR_REQS = all(MISSILE, MORPH_BALL, SPIDER_BALL, SPACE_JUMP_BOOTS, ANY_SUIT,
                                    WAVE_BEAM, ICE_BEAM, ANY_POWER_BOMBS);

    return [
        // 0: Chozo - - - Main Plaza (Half-Pipe) - - - - - - - - Missile Expansion 1
        {
            required: all(MORPH_BALL, BOOST_BALL),
        },

        // 1: Chozo - - - Main Plaza (Grapple Ledge) - - - - - - Missile Expansion 2
        {
            required: all(MISSILE, GRAPPLE_BEAM, ANY_SUIT, BOOST_BALL, MORPH_BALL,
                            MORPH_BALL_BOMB, WAVE_BEAM),
        },

        // 2: Chozo - - - Main Plaza (Tree)  - - - - - - - - - - Missile Expansion 3
        {
            required: all(MISSILE, CHARGE_BEAM, SUPER_MISSILE),
        },

        // 3: Chozo - - - Main Plaza (Locked Door) - - - - - - - Energy Tank 1
        {
            required: all(MISSILE, MORPH_BALL, MORPH_BALL_BOMB),
        },

        // 4: Chozo - - - Ruined Fountain  - - - - - - - - - - - Missile Expansion 4
        {
            required: all(MISSILE, MORPH_BALL, SPIDER_BALL),
        },
        ...
        {
            required: all(MISSILE, MORPH_BALL, BOOST_BALL),
        },

        // 7: Chozo - - - Ruined Shrine (Lower Tunnel) - - - - - Missile Expansion 6
        {
            required: all(MISSILE, MORPH_BALL, MBB_OR_PB),
        },
        ...
        {
            required: all(MISSILE, ANY_SUIT, GRAPPLE_BEAM, WAVE_BEAM, MORPH_BALL, BOOST_BALL,
                          SPIDER_BALL),
        },

        //10: Chozo - - - Ruined Nursery - - - - - - - - - - - - Missile Expansion 8
        {
            required: all(MORPH_BALL, MORPH_BALL_BOMB),
        },
        ...
        {
            required: all(MISSILE, ANY_SUIT, GRAPPLE_BEAM, WAVE_BEAM, MORPH_BALL, ANY_POWER_BOMBS),
        },

        //13: Chozo - - - Tower of Light - - - - - - - - - - - - Wavebuster
        {
            // This actually only requires 75 missiles, but 80 is less hard
            required: all(n_of(MISSILE, 80 / 5), MORPH_BALL, BOOST_BALL, SPIDER_BALL, WAVE_BEAM,
                            SPACE_JUMP_BOOTS),
        },

        //14: Chozo - - - Tower Chamber  - - - - - - - - - - - - Artifact of Lifegiver
        {
            required: all(MISSILE, MORPH_BALL, BOOST_BALL, SPIDER_BALL, WAVE_BEAM, GRAVITY_SUIT),
        },
        ...
        {
            required: all(MISSILE, MORPH_BALL, MBB_OR_PB, SPACE_JUMP_BOOTS),
        },
        ...
        {
            required: all(MISSILE, MORPH_BALL, MORPH_BALL_BOMB, SPIDER_BALL, SUPER_MISSILE),
        },
        ...
        {
            // TODO: Does this actually require Space Jump?
            required: all(MISSILE, MORPH_BALL, MORPH_BALL_BOMB, GRAVITY_SUIT, SPACE_JUMP_BOOTS),
        },
        ...
        {
            required: all(MISSILE, MORPH_BALL, MBB_OR_PB, SPIDER_BALL),
        },
        ...
        {
            required: all(MISSILE, MORPH_BALL, MORPH_BALL_BOMB, ANY_POWER_BOMBS, BOOST_BALL,
                          SPIDER_BALL),
        },
        ...
        {
            required: all(MISSILE, MORPH_BALL, MORPH_BALL_BOMB, SPIDER_BALL, WAVE_BEAM, BOOST_BALL,
        ...
        {
            required: all(MISSILE, MORPH_BALL, MORPH_BALL_BOMB, SPIDER_BALL, WAVE_BEAM,
                          BOOST_BALL, SPACE_JUMP_BOOTS),
            escape: all(ICE_BEAM),
        },
        ...
        //44: Phendrana - Quarantine Cave  - - - - - - - - - - - Spider Ball
        {
            required: any(
                ...
                // Thermal visor is only required for fighting Thardus. It could be removed
        ...
        {
            // TODO: Is thermal visor actually required?
            required: any(
                all(PHENDRANA_REQS, BOOST_BALL, SPACE_JUMP_BOOTS, WAVE_BEAM, ICE_BEAM,
                    THERMAL_VISOR, GRAPPLE_BEAM),
        ...
        //54: Phendrana - Gravity Chamber (Underwater) - - - - - Gravity Suit
        {
            required: any(
                all(PHENDRANA_REQS, BOOST_BALL, SPACE_JUMP_BOOTS, WAVE_BEAM, ICE_BEAM,
                    SPIDER_BALL, THERMAL_VISOR),
                all(BACKWARDS_PHENDRANA_REQS, ICE_BEAM)
            ),
            escape: any(GRAVITY_SUIT),
        },
        ...
        //55: Phendrana - Gravity Chamber (Grapple Ledge)  - - - Missile Expansion 28
        {
            required: any(
                all(PHENDRANA_REQS, BOOST_BALL, SPACE_JUMP_BOOTS, WAVE_BEAM, ICE_BEAM,
                    SPIDER_BALL, THERMAL_VISOR, PLASMA_BEAM, GRAPPLE_BEAM, GRAVITY_SUIT),
        ...
        //56: Phendrana - Storage Cave - - - - - - - - - - - - - Artifact of Spirit
        {
            required: any(
                all(PHENDRANA_REQS, BOOST_BALL, SPACE_JUMP_BOOTS, WAVE_BEAM, ICE_BEAM,
                    SPIDER_BALL, THERMAL_VISOR, PLASMA_BEAM, POWER_BOMB, GRAPPLE_BEAM),
        ...
        //57: Phendrana - Security Cave  - - - - - - - - - - - - Power Bomb Expansion 3
        {
            required: any(
                all(PHENDRANA_REQS, BOOST_BALL, SPACE_JUMP_BOOTS, WAVE_BEAM, ICE_BEAM,
                    SPIDER_BALL, THERMAL_VISOR, GRAPPLE_BEAM),
                all(BACKWARDS_PHENDRANA_REQS, ICE_BEAM, GRAPPLE_BEAM)
            ),
        },
        ...
        {
            required: any(all(MORPH_BALL, MORPH_BALL_BOMB, BOOST_BALL),
                            SPACE_JUMP_BOOTS),
        },
        ...
        {
            // TODO: Space Jump?
            required: all(MISSILE, MORPH_BALL, GRAVITY_SUIT),
        },

        //61: Tallon  - - Overgrown Cavern - - - - - - - - - - - Missile Expansion 31
        {
            // TODO: Space Jump?
            required: all(MISSILE, MORPH_BALL, MORPH_BALL_BOMB, WAVE_BEAM, SPIDER_BALL, BOOST_BALL,
                            ICE_BEAM),
        },
        ...
        {
            required: all(MISSILE, MORPH_BALL, GRAVITY_SUIT, THERMAL_VISOR, WAVE_BEAM, ICE_BEAM),
        },
        ...
        //67: Tallon  - - Biohazard Containment  - - - - - - - - Missile Expansion 35
        {
            required: any(
                ...
                SPACE_JUMP_BOOTS, CHARGE_BEAM, SUPER_MISSILE),
                // Backwards through Phazon Mines. Requires this to contain the thermal visor.
                // TODO This needs to be tested!
                all(MISSILE, MORPH_BALL, MORPH_BALL_BOMB, GRAVITY_SUIT, SPIDER_BALL,
                    SPACE_JUMP_BOOTS, WAVE_BEAM, ICE_BEAM, ANY_POWER_BOMBS, GRAPPLE_BEAM)
            ),
        ...
        //69: Tallon  - - Great Tree Chamber - - - - - - - - - - Missile Expansion 36
        {
            required: any(
                // From frigate
                all(MISSILE, MORPH_BALL, MORPH_BALL_BOMB, WAVE_BEAM, ICE_BEAM, SPACE_JUMP_BOOTS,
        ...
        {
            required: all(MISSILE, MORPH_BALL, GRAVITY_SUIT, WAVE_BEAM, ICE_BEAM,
                            SPACE_JUMP_BOOTS, MORPH_BALL_BOMB, SPIDER_BALL, BOOST_BALL,
                            ANY_POWER_BOMBS),
        },
        ...
        {
            required: all(MISSILE, MORPH_BALL, ANY_SUIT, WAVE_BEAM, ICE_BEAM,
                            SPACE_JUMP_BOOTS, MORPH_BALL_BOMB, SPIDER_BALL, THERMAL_VISOR),
        },
        ...
        //75: Mines - - - Storage Depot B  - - - - - - - - - - - Grapple Beam
        {
            required: any(
                ...
                // TODO Can you lock yourself out of an item? Should it require boost ball?
        ...
        {
            required: any(
                all(MINES_FROM_TALLON_REQS, ANY_POWER_BOMBS, BOOST_BALL, PLASMA_BEAM, XRAY_VISOR,
                                            GRAPPLE_BEAM),
        ...
        {
            required: any(
                all(MINES_FROM_TALLON_REQS, ANY_POWER_BOMBS, BOOST_BALL, XRAY_VISOR, GRAPPLE_BEAM,
                    PLASMA_BEAM),
        ...
        {
            required: any(
                all(MINES_FROM_TALLON_REQS, ANY_POWER_BOMBS, BOOST_BALL, XRAY_VISOR, PLASMA_BEAM,
                    GRAPPLE_BEAM, PHAZON_SUIT),
        ...
        {
            required: all(MISSILE, MORPH_BALL, MBB_OR_PB, ANY_SUIT, SPACE_JUMP_BOOTS),
        },
        ...
        {
            required: all(MISSILE, MORPH_BALL, MBB_OR_PB, ANY_SUIT),
        },

        //93: Magmoor - - Transport Tunnel A - - - - - - - - - - Energy Tank 13
        {
            required: all(MISSILE, MORPH_BALL, MORPH_BALL_BOMB, ANY_SUIT),
        },

        //94: Magmoor - - Warrior Shrine - - - - - - - - - - - - Artifact of Strength
        {
            required: all(MISSILE, MORPH_BALL, ANY_SUIT, SPACE_JUMP_BOOTS, BOOST_BALL),
        },

        //95: Magmoor - - Shore Tunnel - - - - - - - - - - - - - Ice Spreader
        {
            required: all(MISSILE, MORPH_BALL, ANY_POWER_BOMBS, ANY_SUIT, SPACE_JUMP_BOOTS),
        },
        ...
        {
            required: all(MISSILE, MORPH_BALL, ANY_SUIT, SPACE_JUMP_BOOTS, BOOST_BALL, SPIDER_BALL,
                            GRAPPLE_BEAM, WAVE_BEAM, ICE_BEAM),
        },

        //99: Magmoor - - Magmoor Workstation  - - - - - - - - - Energy Tank 14
        {
            required: all(MISSILE, MORPH_BALL, ANY_SUIT, SPACE_JUMP_BOOTS, SPIDER_BALL,
                            WAVE_BEAM, THERMAL_VISOR),
        },
